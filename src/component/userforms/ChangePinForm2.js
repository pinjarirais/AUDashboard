        ...
        <>
            <form className='space-y-3' onSubmit={handleSubmit(onSubmit)}>
                <div className='feild w-full'>
                    ...
                    <input {...register("otp")} className='w-full rounded-md bg-white px-3 py-1.5 text-base sm:text-sm/6 border-[1px] border-[#a3a5aa] focus:border-[#6d3078] focus:ring-1 focus:ring-[#6d3078] focus:outline-none' placeholder='Enter OTP'
                        onBlur={() => trigger("otp")}
                        maxLength={6}
                    />
